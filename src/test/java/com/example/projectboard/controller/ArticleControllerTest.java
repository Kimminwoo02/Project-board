...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "minuTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @Test
    void givenNothing_whenRequesting_thenReturnsUpdatedArticlePage1() throws Exception {
        // Given
        long articleId = 1L;
